...
import { FaEdit, FaTrash, FaEllipsisH, FaExclamationTriangle } from 'react-icons/fa';
import '../styles/comment-section.css';

const CommentSection = ({ postId, comments, handleAddComment, onEditComment, onDeleteComment, onReportComment, currentUser }) => {
    ...
    return (
        <div className="comment-section">
            <h5 className="comment-section-header">
                Comments ({comments.length})
            </h5>

            {hasMoreComments && !showAllComments && (
                <button onClick={() => setShowAllComments(true)} className="view-more-comments-btn show">
            ...
            <div className="comments-list">
                {commentsToDisplay.map((comment, index) => (
                    <div key={comment.id || index} className="comment">
                        <img src={comment.authorAvatar} alt="avatar" className="comment-avatar" />
            ...
            {hasMoreComments && showAllComments && (
                <button onClick={() => setShowAllComments(false)} className="view-more-comments-btn hide">
                    Hide comments
                </button>
            )}
