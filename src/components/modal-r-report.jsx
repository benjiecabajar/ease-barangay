        ...
        <form className="report-form" onSubmit={handleSubmit}>
          ...
          <div className="setting-item-column">
            ...
            <div className="evidence-buttons">
              ...
              <button type="button" className="evidence-btn" onClick={startCamera}>
          ...
          <div className="setting-item-column">
            ...
            {location ? (
              <div className="location-preview osm-preview">
                <iframe
                  src={`https://www.openstreetmap.org/export/embed.html?bbox=${location.lng - 0.0005},${location.lat - 0.00025},${location.lng + 0.0005},${location.lat + 0.00025}&layer=mapnik&marker=${location.lat},${location.lng}`}
                  title="Report Location Preview"
                />
                <div className="location-actions">
                  <button type="button" className="refresh-location-btn" onClick={handleGetLocation} disabled={isFetchingLocation}>
                    <FaSyncAlt className={isFetchingLocation ? 'spin' : ''} />
                    {isFetchingLocation ? 'Refreshing...' : 'Refresh'}
                  </button>
                  <button type="button" className="remove-location-btn" onClick={handleRemoveLocation}>
                    <FaTimes /> Remove
                  </button>
                </div>
              ...
              <button type="button" className="evidence-btn location-btn" onClick={handleGetLocation} disabled={isFetchingLocation}>
                <FaMapMarkerAlt size={16} />
                {isFetchingLocation ? 'Getting Location...' : 'Add Current Location'}
              </button>
            )}
          </div>
          ...
          {/* Submit */}
          <button type="submit" className="submit-report-btn" disabled={!reportType || !description}>
